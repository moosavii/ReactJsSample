...
import { AccountBoxOutlined, AccountCircleOutlined, CancelPresentation, ExitToApp, ManageAccounts, ManageAccountsOutlined, PersonOutline } from '@mui/icons-material';
...
function DashboardContent() {
  ...
  return (
      <Box sx={{ display: 'flex' }}>
        ...
        <Drawer variant="permanent" open={open} sx ={{   height: '100vh',  overflow: 'auto',}}>
          <Toolbar
            sx={{
              display: 'flex',
              alignItems: 'center',
